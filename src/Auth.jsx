...
export default function Auth() {
  ...
  return (
    <>
      <GoogleOAuthProvider clientId="40897424874-rf865c53ped009gq46vpda93mjhltp2p.apps.googleusercontent.com">
              ...
              <div className="flex flex-col ml-3">
                <div className="relative border-[2px] mb-2 p-2 mr-9 ml-5 rounded-full">
                  <input
                    ...
                    className="outline-none px-[13px]"
                    style={{
                      backgroundClip: "text",
                    }}
                  />
                ...
                <div>
                  <button
                    className="border-double focus:border-4 border-2 border-white rounded-full bg-red-600 hover:bg-red-700 focus:bg-red-800 text-white px-4 py-2 mr-72 ml-5"
                    type="submit"
                  >
                    Login
                  </button>
                ...
                <div className="flex items-center justify-center mt-4 mb-4">
                  <div className=" flex-grow ml-6 border-t border-gray-300 mr-3"></div>
                  <div className="mr-1">Not Registered?</div>
                  <div
                  ...
                  <div className="flex-grow border-t border-gray-300 mr-9"></div>
                </div>
              </div>
            </form>
