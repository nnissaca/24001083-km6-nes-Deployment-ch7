  ...
  return (
    <>
      <div>
        ...
        <h1 className="text-center mt-14 my-3 font-bold text-white text-3xl">
          Genre Movie
        </h1>
      ...
      <div className="flex justify-between px-10">
        <button
          className="border-white border-4 hover:bg-white hover:text-black text-white px-4 py-2 rounded-lg"
