...
export default function BeforeLogIn() {
  ...
  const filteredMovie =
    popular && popular.length > 0 ? popular.slice(0, 4) : [];
  ...
  return (
    <>
      <div className="sticky-header flex items-center justify-between w-[100%] mt-3 absolute px-5">
        <div className="flex items-center text-5xl text-shadow-black text-red-600">
          <strong
            onClick={() => {
              navigate("/");
            }}
        ...
        <div className="flex">
          <ul className="flex justify-center items-center align-center text-white">
            ...
            <div
              ...
              className="p-2 px-5 border-2 border-white rounded-full hover:text-red-600 hover:border-red-600 text-red-600 bg-white mx-5"
            >
              Login
            </div>
            <div
              ...
              className="p-2 px-4 border-2 border-black rounded-full hover:border-red-600 hover:bg-black text-red-600 bg-black"
            >
              Register
            </div>
          </ul>
