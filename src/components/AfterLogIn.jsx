  ...
  return (
    <>
      <div className="sticky-header flex items-center justify-between w-[100%] mt-3 absolute px-5">
        <div className="flex items-center text-5xl text-red-600 text-shadow-black">
          <strong
            onClick={() => {
              navigate("/");
            }}
        ...
        <div className="flex">
          <ul className="flex justify-center items-center align-center text-white">
            ...
            <button
              ...
              className="p-2 px-5 border-2 border-red-600 hover:border-white rounded-full text-white mx-5 bg-red-600"
            >
              Logout
            </button>
          </ul>
